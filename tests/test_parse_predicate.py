...
from quod.predicate.canonical import canonicalize, predicate_for_param_range, predicate_for_return_range
...
from quod.predicate.render import recognize_predicate
