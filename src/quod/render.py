...
# ---------- Predicate sugar recognizer ----------
#
# Inverse of the CLI desugaring at `claim add` / `claim relax`. Operates on
...
# outside the sugar table fall back to raw expression rendering.
